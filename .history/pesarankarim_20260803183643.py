...
async def check_callback(update, context):
    ...
    if await real_member(context, user_id):
        ...
        await query.answer("❌ شما هنوز عضو کانال نشدید! لطفاً ابتدا عضو شوید.", show_alert=True)
        
        await query.edit_message_text(
            "❌ شما هنوز عضو کانال نشدید!\n\n"
            "لطفاً ابتدا روی دکمه‌ی **عضویت در کانال** کلیک کنید و عضو شوید.\n\n"

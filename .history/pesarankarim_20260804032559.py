...
BTN_MASHHAD_APP = KeyboardButton("اپلیکیشن پسران کریم (اندروید)")
BTN_MASHHAD_MENU = KeyboardButton("منوی دو زبانه")
BTN_MASHHAD_FULL_MENU = KeyboardButton("منو کامل رستوران")
BTN_MASHHAD_ORDER = KeyboardButton("سفارش آنلاین و رزرو مجالس")
BTN_MASHHAD_PHONE_ORDER = KeyboardButton("سفارش تلفنی و رزرو مجالس")
BTN_MASHHAD_LOCATION = KeyboardButton("مسیریابی به ما")
BTN_MASHHAD_ADDRESS = KeyboardButton("آدرس ما")
BTN_MASHHAD_SOCIAL = KeyboardButton("شبکه های اجتماعی")
BTN_MASHHAD_HISTORY = KeyboardButton("تاریخچه ما")

BTN_TEHRAN_PHOTO = KeyboardButton("دریافت عکس یادگاری")
BTN_TEHRAN_APP = KeyboardButton("اپلیکیشن پسران کریم (اندروید)")
BTN_TEHRAN_MENU = KeyboardButton("منوی دو زبانه")
BTN_TEHRAN_FULL_MENU = KeyboardButton("منو کامل رستوران")
BTN_TEHRAN_ORDER = KeyboardButton("سفارش آنلاین و رزرو مجالس")
BTN_TEHRAN_PHONE_ORDER = KeyboardButton("سفارش تلفنی و رزرو مجالس")
BTN_TEHRAN_LOCATION = KeyboardButton("مسیریابی به ما")
BTN_TEHRAN_ADDRESS = KeyboardButton("آدرس ما")
BTN_TEHRAN_SOCIAL = KeyboardButton("شبکه های اجتماعی")
BTN_TEHRAN_HISTORY = KeyboardButton("تاریخچه ما")
...
async def handle_all_messages(update, context):
    ...
    if branch == "mashhad":
        if text == "📸 دریافت عکس یادگاری":
            ...
            photo_id = "AgACAgQAAxkBAAMqanEj2MLiw14B2wnHUMBorBS4H9cAAmYVaxuTBolTm8Nqa6UWBSQBAAMCAAN5AAM9BA"
